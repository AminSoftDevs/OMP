...
class DepositDigitalCurrenciesViewController: BaseViewController {
    ...
    private lazy var walletAddressDescriptionLabel: UILabel = {
        var label = UILabel()
        label.configure(text: "walletAddressDescriptionLabel".localized, fontSize: 14, textColor: .white, textAlignment: .right, fontType: .regular)
    ...
    private lazy var walletBalanceTitleLabel: UILabel = {
       var label = UILabel()
        label.configure(text: "walletBalance".localized + " :", fontSize: 15, textColor: .white, textAlignment: .right, fontType: .regular)
    ...
    private lazy var walletBalanceLabel: UILabel = {
       var label = UILabel()
        label.configure(text: viewModel.balance, fontSize: 16, textColor: .white, textAlignment: .center, fontType: .regular)
        return label
    }()
    
    private lazy var refreshBalanceButton: UIButton = {
        var button = UIButton()
        button.setImage(UIImage(named: "repeat_icon"), for: .normal)
        button.tintColor = .rejectOrange
        button.layer.cornerRadius = 15
        button.backgroundColor = .rejectOrange.withAlphaComponent(0.15)
    ...
    private func addingQRCodeImageView() {
        ...
        NSLayoutConstraint.activate([
            ...
            QRCodeImageView.centerXAnchor.constraint(equalTo: containerView.centerXAnchor, constant: 0),
            QRCodeImageView.widthAnchor.constraint(equalTo: containerView.heightAnchor, multiplier: 0.25),
            QRCodeImageView.heightAnchor.constraint(equalTo: containerView.heightAnchor, multiplier: 0.25),
        ])
    }
    ...
    private func addingRefreshBalanceButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            refreshBalanceButton.widthAnchor.constraint(equalTo: containerView.widthAnchor, multiplier: 0, constant: 60),
            refreshBalanceButton.heightAnchor.constraint(equalTo: containerView.widthAnchor, multiplier: 0, constant: 60),
        ])
    }
    ...
    private func addingWalletBalanceTitleLabel() {
        ...
        NSLayoutConstraint.activate([
            walletBalanceTitleLabel.centerYAnchor.constraint(equalTo: refreshBalanceButton.centerYAnchor, constant: 0),
