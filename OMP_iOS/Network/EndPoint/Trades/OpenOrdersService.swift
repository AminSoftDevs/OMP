...
struct OpenOrdersService: EndPointType {
    ...
    var task: HTTPTask<Request> {
        return .urlRequest(urlParameters: [
                                           "status": requestModel.status.rawValue])
    }
...
extension OpenOrdersService {
    ...
    static func getOpenOrders(request: Request, completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
