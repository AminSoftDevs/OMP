...
struct MarketsListService: EndPointType {
...
extension MarketsListService {
    ...
    static func getMarketsList(completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
