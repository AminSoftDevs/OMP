...
struct AddNewBankAccountService: EndPointType {
...
extension AddNewBankAccountService {
    ...
    static func addNewBankAccountRequest(request: Request,completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
