...
struct ProvinceListService: EndPointType {
...
extension ProvinceListService {
    ...
    static func getProvinceList(completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
