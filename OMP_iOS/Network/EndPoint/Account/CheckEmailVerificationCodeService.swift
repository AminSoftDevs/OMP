//
//  CheckEmailVerificationCodeService.swift
//  OMP_iOS
//
...
struct CheckEmailVerificationCodeService: EndPointType {
    ...
    var path: String {
        return "/user/verification/email/verify"
    }
...
extension CheckEmailVerificationCodeService {
    ...
    static func checkEmailVerificationCodeRequest(request: Request,completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
