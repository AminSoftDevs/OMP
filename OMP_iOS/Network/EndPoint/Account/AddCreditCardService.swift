...
struct AddNewCreditCardService: EndPointType {
...
extension AddNewCreditCardService {
    ...
    static func addNewCreditCardRequest(request: Request,completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
