//
//  MobileVerificationCodeRequestService.swift
//  OMP_iOS
//
...
struct MobileVerificationCodeRequestService: EndPointType {
...
extension MobileVerificationCodeRequestService {
    ...
    static func mobileVerificationCodeRequest(request: Request,completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
