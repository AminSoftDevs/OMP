//
//  CheckLandlineVerificationCodeService.swift
//  OMP_iOS
//
...
struct CheckLandlineVerificationCodeService: EndPointType {
    ...
    var path: String {
        return "/user/verification/landline-phone/verify"
    }
...
extension CheckLandlineVerificationCodeService {
    ...
    static func checkLandlineVerificationCodeRequest(request: Request, completion: @escaping (Result<NetworkResult<Response, ErrorResponse>, NetworkError>) -> Void) {
